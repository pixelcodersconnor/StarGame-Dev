...
public class Sound {
	...
	//public static final Sound enemyHit = new Sound("/enemy_hit.wav");
	//public static final Sound playerHit = new Sound("/player_hit.wav");
	public static final Sound shaunEgg1 = new Sound("/music/easter_eggs/shaun_1.wav");
	public static final Sound shaunEgg2 = new Sound("/music/easter_eggs/shaun_2.wav");
